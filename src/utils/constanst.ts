export enum AppConstants {
  PATIENTS_PROVIDER = 'PATIENTS_REPOSITORY',
  PATIENTS_MODULE_NAME = 'patients',
  DOCTORS_MODULE_NAME = 'doctors',
  APPOINTMENTS_MODULE_NAME = 'appointments',
  ...
  DOCTORS_PROVIDER = 'DOCTORS_REPOSITORY',
}
